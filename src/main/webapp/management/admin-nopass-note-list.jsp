...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn"
                onclick="location='/management/Note/doShow?page=1&url=management/admin-pass-note-list'">已审核笔记
        </button>
        <button class="layui-btn"
                onclick="location='/management/Note/doShow?page=1&status=0&url=management/admin-waitpass-note-list'">
            待审核笔记
        </button>
    ...
    <div class="page">
        <div>
            <a class="num"
               href="/management/Note/doShow?page=${pageInfo.firstPage}&status=2&url=management/admin-nopass-note-list "
               onmousemove="window.status=''">首页</a>
            <a class="prev"
               href="/management/Note/doShow?page=${pageInfo.prePage}&status=2&url=management/admin-nopass-note-list"
               onmousemove="window.status=''">&lt;&lt;</a>
            第${pageInfo.pageNum}页
            <a class="next"
               href="/management/Note/doShow?page=${pageInfo.nextPage}&status=2&url=management/admin-nopass-note-list"
               onmousemove="window.status=''">&gt;&gt;</a>
            <a class="num"
               href="/management/Note/doShow?page=${pageInfo.lastPage}&status=2&url=management/admin-nopass-note-list"
