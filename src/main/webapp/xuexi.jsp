...
<div id="box" style="width: 980px;margin: 0 auto; position: relative">
    ...
    <div class="mid">
        ...
        <div class="mid_left" style="font-size:14px;color:blue;font-weight: bold;padding-top: 5px;padding-left: 10px;">
            ...
            <a href="/management/Note/doShow?uid=${user.userid}&url=mynote">
                <div style="margin-top: 20px;margin-left: 20px">
                    <button class="layui-btn layui-btn-normal" onclick="">我的笔记</button>
                </div>
            </a>
        </div>
        ...
        <div class="mid_center">
            ...
            <div style="width:300px;height: 30px;margin-left: 13px;margin-top:10px;">
                <ul style="float: left">
                    <a href="/management/Note/doShow?page=${pageInfo.firstPage}&url=xuexi" onmousemove="window.status=''">
                        <li>首页</li>
                    </a>
                    <a href="/management/Note/doShow?page=${pageInfo.prePage}&url=xuexi" onmousemove="window.status=''">
                        <li>上一页</li>
                    </a>
                    <a href="/management/Note/doShow?page=${pageInfo.nextPage}&url=xuexi" onmousemove="window.status=''">
                        <li>下一页</li>
                    </a>
                    <a href="/management/Note/doShow?page=${pageInfo.lastPage}&url=xuexi" onmousemove="window.status=''">
                        <li>尾页</li>
                    </a>
                </ul>
            </div>
            ...
            <div class="tiaozhaun">
                <form action="/management/Note/doShow" id="form2" method="post">
                    ...
                    <input type="hidden" name="url" value="xuexi"/>
                </form>
            </div>
            <table>
                <tr height="35px">
