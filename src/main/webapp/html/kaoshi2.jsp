	...
	<div class="mid">
		...
		<div class="midmain">
			<div class="midmaintop">
				<ul>
					<li style="width: 81px;font-weight: bold;background-color: #d5dbe6">科目名称</li>
					<li style="width: 106px;font-weight: bold;background-color: #d5dbe6">试卷名</li>
					<li style="width: 55px;font-weight: bold;background-color: #d5dbe6">总分数</li>
					<li style="width: 80px;font-weight: bold;background-color: #d5dbe6">考试时长</li>
					<li style="width: 277px;font-weight: bold;background-color: #d5dbe6">开始时间</li>
					<li style="width: 257px;font-weight: bold;background-color: #d5dbe6">结束时间</li>
					...
					$.ajax({
						...
						success: function(res){
							...
							for(var i = 0; i<list.length;i++){
								var obj = list[i];
								var str = "<ul>" +
										"<li style=\"width: 81px;\">"+obj.subName+"</li>\n" +
										"<li style=\"width: 106px;\">"+obj.paper.par_name+"</li>\n" +
										"<li style=\"width: 55px;\">"+obj.allScore+"</li>\n" +
										"<li style=\"width: 80px;\">"+obj.paper.test_length_time+"</li>\n" +
										"<li style=\"width: 277px;\">"+obj.paper.test_start_time+"</li>\n" +
										"<li style=\"width: 257px;\">"+obj.paper.test_end_time+"</li>\n" +
										"<li style=\"width: 109px;\"><button onclick=\"turnToExam("+obj.paper.par_id+")\" class=\"layui-btn layui-btn-xs layui-btn-danger\" id=\""+obj.paper.par_id+"\">进入考试</button></li>" +
										"</ul>";
								$("#records").append(str);
							}
				...
				function turnToExam(par_id) {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            // alert(res.code);
                            // alert(res.msg);
                            if(parseInt(res.code)=='9990'){
                                location.href="/exam/kaoshi?par_id="+par_id;
                            }else {
                                layer.alert(res.msg )
                            }
                        }
