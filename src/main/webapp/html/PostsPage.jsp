...
<div id="container">
    <%--内容的开始--%>
<div id="Posts">
    <c:forEach items="${rooflist}" var="temp">
        <span  style="font-size: 32px;color: red;">置顶帖</span>
        <div class="topPosts">
            <div class="btnPostsImg"><img height="100px" width="100px" src="${temp.post_image}"> </div>
            <div class="btnPostsContent">
                <a href="${pageContext.request.contextPath}/management/Posts/getPostAndReplyPost?post_id=${temp.post_id}">
                    <div class="btnPostsTitle">${temp.post_title}
                        <c:if test="${temp.user_id  eq   sessionScope.user.userid}">
            ...
            <%--<img height="100px;" width="100px;" src="${temp.post_image}">--%>
         </div>
...
<div class="page">
    <a href="${pageContext.request.contextPath}/management/Posts/getPostsByPlate?page=1&id=${plate_id}" >首页</a>
    <a href="${pageContext.request.contextPath}/management/Posts/getPostsByPlate?page=${pageInfo.getPrePage()}&id=${plate_id}">上一页</a>
    <a href="${pageContext.request.contextPath}/management/Posts/getPostsByPlate?page=${pageInfo.getNextPage()}&id=${plate_id}">下一页</a>
    <a href="${pageContext.request.contextPath}/management/Posts/getPostsByPlate?page=${pageInfo.getLastPage()}&id=${plate_id}">末页</a>
</div>
</div>
<div class="bodyright">
